...
1. Copy the DLL:
    ...
    * Linux: Copy `$DLSS_SDK/lib/Linux_x86_64/rel/libnvidia-ngx-dlss.so.310.5.3` to the same directory as your app
...
3. Additionally, for DLSS ray reconstruction:
    ...
    * Linux: Copy `$DLSS_SDK/lib/Linux_x86_64/rel/libnvidia-ngx-dlssd.so.310.5.3` to the same directory as your app
